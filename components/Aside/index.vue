    ...
    <div v-for='(menu, index) in menuList' :key='index'>
      ...
      <div v-for='(item, index) in menu.children'>
        <div class='menu' v-if='menuType === 0||menuType === 1'>
          <nuxt-link :key='index' :to='item.path' :class="activePath === item.path ? 'menu-item_active' : 'menu-item'">
            <i :class='item.icon'></i>
        ...
        <div v-if='menuType === 2'>
          <el-menu
            ...
            <el-submenu v-if='item.children.length>0'>
              ...
              <el-menu-item-group>
                <el-menu-item :index='a.path' v-for='a in item.children'>{{ a.title }}</el-menu-item>
              </el-menu-item-group>
            </el-submenu>
          </el-menu>
        </div>
