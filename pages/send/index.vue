      ...
      <div class="main">
        ...
        <div class="main-content">
            ...
            <el-tabs type="border-card">
              <el-tab-pane label="从文件中导入">
                ...
                <div class="send-button">
                  <el-button style="width: 185px" type="primary" plain>选取文件</el-button>
                  <span>未选取文件</span>
                </div>
              </el-tab-pane>
          ...
          <div class="send-bottom">
            <h4>请注意</h4>
            <p>•地址簿模式：地址簿模式单次发送上限为100万个联系人，不支持变量</p>
            <p>•文件导入模式：文件导入模式单次发送上限为5万个联系人，支持变量</p>
            <p>•手动输入模式：手动模式单次提交不超过1000个联系人，支持变量</p>
            <p>•当单击发送按钮后，需要等待页面处理完成后才能关闭本页，否则会导致发送失败！等待时间视您提交的联系人数量而定，等待时间会随之递增，最长不超过900秒</p>
          </div>
          <el-button style="margin-top: 20px;width: 120px" type="primary">发送</el-button>
        </div>
      </div>
    </div>
  </div>
